...
/***/ function(module, exports, __webpack_require__) {
	...
	var _GalleryBox = __webpack_require__(173);

	__webpack_require__(169);

	_reactDom2['default'].render(_react2['default'].createElement(_GalleryBox.GalleryBox, { url: '/uzivatel/galleries/' + location.pathname.slice(10) }), document.querySelector('.app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _GalleryList = __webpack_require__(174);
		...
		function GalleryBox() {
			...
			this.render = function () {
				return _react2['default'].createElement(
					...
					_react2['default'].createElement(_GalleryList.GalleryList, { data: _this.state.data })
				);
			};
		}
			...
			this.render = function () {
				var galleryNodes = _this.props.data.map(function (gallery, i) {
					if (!gallery.pictures || !gallery.pictures.length) {
						return _react2['default'].createElement(_Gallery.Gallery, { key: i,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Gallery = (function (_React$Component) {
		...
		function Gallery() {
			...
			this.render = function () {
				var src = "/pics/" + _this.props.id + "/" + _this.props.imgUrl;
				...
				return _react2["default"].createElement(
					...
					_react2["default"].createElement(
						...
						_react2["default"].createElement(
							...
							_react2["default"].createElement("img", { src: src, className: "img-bg" })
						)
					)
				);
			};
