...
/***/ function(module, exports, __webpack_require__) {
	...
	var _searchApp = __webpack_require__(200);

	__webpack_require__(169);

	_reactDom2['default'].render(_react2['default'].createElement(_searchApp.SearchApp, { url: '/uzivatele/all' }), document.querySelector('.search-app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SearchApp = (function (_React$Component) {
		...
		function SearchApp() {
			...
			_get(Object.getPrototypeOf(SearchApp.prototype), 'constructor', this).apply(this, arguments);
			...
			this.handleSearch = function (filteredText) {
				_this.setState({
			...
			this.render = function () {
				return _react2['default'].createElement(
					...
					_react2['default'].createElement(_searchForm.SearchForm, { onTextChange: _this.handleSearch, filteredText: _this.state.filteredText }),
					_react2['default'].createElement(_usersList.UsersList, { users: _this.state.data, filterValue: _this.state.filteredText })
				);
			};
		}
	...
	var SearchForm = (function (_React$Component) {
		...
		function SearchForm() {
			...
			this.handleChange = function () {
				var filteredText = _this.refs.input.value;
				_this.props.onTextChange(filteredText);
			};
			...
			this.render = function () {
				return _react2["default"].createElement(
					...
					_react2["default"].createElement(
						"label",
						{ htmlFor: "search", className: "search-label" },
						"Vyhledávání uživatelů"
					),
					_react2["default"].createElement("input", { type: "text",
						ref: "input",
						onChange: _this.handleChange,
						value: _this.props.filteredText,
						id: "search",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UsersList = (function (_React$Component) {
		...
		function UsersList() {
			...
			this.render = function () {
				var usersNodes = _this.props.users.map(function (user, i) {
					if (user.name.toLowerCase().indexOf(_this.props.filterValue.toLowerCase()) !== -1) {
						return _react2['default'].createElement(_user.User, { key: i, name: user.name, url: '/uzivatel/' + user.id });
					}
				});
				return _react2['default'].createElement(
					'div',
