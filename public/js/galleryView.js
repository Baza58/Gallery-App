...
/***/ function(module, exports, __webpack_require__) {
	...
	var _GalleryBox = __webpack_require__(189);

	__webpack_require__(169);

	_reactDom2['default'].render(_react2['default'].createElement(_GalleryBox.GalleryBox, { url: '/api/photos/' + location.pathname.match(/\/([0-9]+)/)[1] }), document.querySelector('.app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/sass-loader/index.js?indentedSyntax!./app.sass", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/sass-loader/index.js?indentedSyntax!./app.sass");
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _GalleryHeader = __webpack_require__(190);

	var _GalleryList = __webpack_require__(191);

	var _GalleryForm = __webpack_require__(193);

	var _GalleryModal = __webpack_require__(194);
	...
	var GalleryBox = (function (_React$Component) {
		...
		function GalleryBox() {
			...
			_get(Object.getPrototypeOf(GalleryBox.prototype), 'constructor', this).apply(this, arguments);
			...
			this.deletePicture = function (picture_id) {
				$.ajax({
					method: 'DELETE',
					url: '/api/photos/delete/' + picture_id,
					success: function success(data) {
						_this.setState({
							data: data.data
						});
			...
			this.addPicture = function (data) {
				_this.setState({
					data: data.data
				});
			};

			this.pictureVisible = function (id, src) {
				_this.setState({
					id: id,
					src: src,
					visible: 'modal visible'
			...
			this.handleHide = function () {
				var url = '/home/' + _this.state.userName + '/' + _this.state.data[0].gallery_id;
			...
			this.nextImage = function (id) {
				...
				_this.state.data.map(function (picture, i) {
					if (picture.id == id) {
						instance = picture;
					}
				});

				var i = _this.state.data.indexOf(instance) + 1;
				if (_this.state.data[i] != null) {
					var src = '/pics/' + _this.state.data[i].gallery_id + '/' + _this.state.data[i].url;
					_this.setState({
						id: _this.state.data[i].id,
						src: src,
						visible: 'modal visible'
					});
					var url = '/p/' + _this.state.data[i].id;
					history.pushState({ state: src, id: _this.state.data[i].id }, '', url);
				}
			};

			this.prevImage = function (id) {
				var instance = undefined;
			...
			this.render = function () {
				return _react2['default'].createElement(
					...
					_react2['default'].createElement(_GalleryHeader.GalleryHeader, { title: _this.state.title, description: _this.state.description }),
					_react2['default'].createElement(_GalleryList.GalleryList, { data: _this.state.data, onDelete: _this.deletePicture, onPictureVisible: _this.pictureVisible }),
					_react2['default'].createElement('hr', null),
					_react2['default'].createElement(_GalleryForm.GalleryForm, { onNewPicture: _this.addPicture }),
					_react2['default'].createElement(_GalleryModal.GalleryModal, { id: _this.state.id,
						source: _this.state.src,
						visible: _this.state.visible,
						onModalHide: _this.handleHide,
						changeNextImage: _this.nextImage,
						changePrevImage: _this.prevImage })
				);
			};
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GalleryHeader = (function (_React$Component) {
		...
		function GalleryHeader() {
			...
			_get(Object.getPrototypeOf(GalleryHeader.prototype), "constructor", this).apply(this, arguments);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Picture = __webpack_require__(192);
	...
	var GalleryList = (function (_React$Component) {
		...
		function GalleryList() {
			...
			_get(Object.getPrototypeOf(GalleryList.prototype), 'constructor', this).apply(this, arguments);

			this.handleDelete = function (picture_id) {
				_this.props.onDelete(picture_id);
			};

			this.handleVisible = function (id, src) {
				_this.props.onPictureVisible(id, src);
			};

			this.render = function () {
				var pictureNodes = _this.props.data.map(function (picture, i) {
					return _react2['default'].createElement(_Picture.Picture, { key: i,
						onPictureDelete: _this.handleDelete,
						onPictureVisible: _this.handleVisible,
				...
				return _react2['default'].createElement(
					...
					_react2['default'].createElement(
						...
						{ transitionName: 'appear', transitionEnterTimeout: 500, transitionLeaveTimeout: 300, className: 'pictures-container' },
						pictureNodes
					)
				);
			};
	...
	var Picture = (function (_React$Component) {
		...
		function Picture() {
			...
			this.handleClick = function (e) {
				e.stopPropagation();
				e.preventDefault();
				_this.props.onPictureDelete(_this.props.picture_id);
			};

			this.handleVisible = function (e) {
				e.preventDefault();
				var id = _this.props.picture_id;
				var src = '/pics/' + _this.props.gallery_id + '/' + _this.props.url;
				var url = '/p/' + _this.props.picture_id;
				history.pushState({ state: src }, '', url);
			...
			this.render = function () {
				return _react2['default'].createElement(
					...
					_react2['default'].createElement(
						'a',
						{ href: '#', className: 'thumbnail', id: _this.props.id, onClick: _this.handleVisible },
						_react2['default'].createElement(
							'button',
							{ type: 'button',
						...
						_react2['default'].createElement('img', { src: '/pics/' + _this.props.gallery_id + '/' + _this.props.url, alt: '' })
					)
				);
			};
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GalleryForm = (function (_React$Component) {
		_inherits(GalleryForm, _React$Component);
		...
		function GalleryForm() {
			...
			_get(Object.getPrototypeOf(GalleryForm.prototype), 'constructor', this).apply(this, arguments);

			this.handleSubmit = function (e) {
				e.preventDefault();
				var files = _react2['default'].findDOMNode(_this.refs.files);
			...
			this.render = function () {
				return _react2['default'].createElement(
					...
					_react2['default'].createElement(
						...
						_react2['default'].createElement('input', { type: 'file', ref: 'files', name: 'files[]', accept: 'image/*', className: 'file-input', required: true, multiple: true }),
						_react2['default'].createElement(
							'div',
							{ className: 'photos-size' },
							' Velikost fotky musí být menší než 2MB. '
						),
						_react2['default'].createElement(
							'button',
							{ type: 'submit', className: 'btn btn-primary submit-btn' },
							'Přidat fotky'
						)
					)
				);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GalleryModal = (function (_React$Component) {
		_inherits(GalleryModal, _React$Component);
		...
		function GalleryModal() {
			...
			_get(Object.getPrototypeOf(GalleryModal.prototype), "constructor", this).apply(this, arguments);

			this.handleClick = function (e) {
				_this.props.onModalHide();
			};

			this.handleImgClick = function (e) {
				e.stopPropagation();
			};

			this.nextImage = function (e) {
				e.stopPropagation();
				_this.props.changeNextImage(_this.props.id);
			};

			this.prevImage = function (e) {
				e.stopPropagation();
				_this.props.changePrevImage(_this.props.id);
			};

			this.render = function () {
				return _react2["default"].createElement(
					"div",
					{ className: _this.props.visible, onClick: _this.handleClick },
					_react2["default"].createElement(
						"div",
						{ className: "modal-ctn" },
						_react2["default"].createElement("span", { className: "glyphicon glyphicon-menu-left arrow-left",
							"aria-hidden": "true",
							onClick: _this.prevImage }),
						_react2["default"].createElement("img", { src: _this.props.source, className: "modal-img", alt: "", ref: "img", onClick: _this.handleImgClick }),
						_react2["default"].createElement(
							"button",
						...
						_react2["default"].createElement("span", { className: "glyphicon glyphicon-menu-right arrow-right",
							"aria-hidden": "true",
							onClick: _this.nextImage })
					)
				);
			};
		}
