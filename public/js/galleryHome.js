...
/***/ function(module, exports, __webpack_require__) {
	...
	var _GalleryBox = __webpack_require__(158);

	__webpack_require__(169);

	_reactDom2['default'].render(_react2['default'].createElement(_GalleryBox.GalleryBox, { url: '/api/photos' }), document.querySelector('.app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _GalleryList = __webpack_require__(159);

	var _GalleryForm = __webpack_require__(168);
	...
	var GalleryBox = (function (_React$Component) {
		...
		function GalleryBox() {
			...
			this.handleGallery = function (gallery) {
				...
				var newData = data.concat([gallery]);
				_this.setState({
					data: newData
				});
			...
			this.handleDeleteGallery = function (id) {
				$.ajax({
					method: 'DELETE',
			...
			this.render = function () {
				return _react2['default'].createElement(
					'div',
					null,
					_react2['default'].createElement(_GalleryList.GalleryList, { onDelete: _this.handleDeleteGallery, data: _this.state.data, userName: _this.state.userName }),
					_react2['default'].createElement('hr', null),
					_react2['default'].createElement(_GalleryForm.GalleryForm, { onFormSubmit: _this.handleGallery })
				);
			};
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _galleryJs = __webpack_require__(167);
	...
	var GalleryList = (function (_React$Component) {
		...
		function GalleryList() {
			...
			this.render = function () {
				var galleryNodes = _this.props.data.map(function (gallery, i) {
					if (!gallery.pictures || !gallery.pictures.length) {
						return _react2['default'].createElement(_galleryJs.Gallery, { key: i,
							link: '/home/' + _this.props.userName + '/' + gallery.id,
							onGalleryDelete: _this.handleDelete,
							title: gallery.title,
				...
				return _react2['default'].createElement(
					...
					{ transitionName: 'appear', transitionEnterTimeout: 500, transitionLeaveTimeout: 300, className: 'gallery-container' },
					galleryNodes
				);
			};
		}
	...
	var Gallery = (function (_React$Component) {
		...
		function Gallery() {
			...
			this.handleClick = function (e) {
				e.stopPropagation();
				_this.props.onGalleryDelete(_this.props.id);
				_this.refs.btn.blur();
			};

			this.render = function () {
				if (!_this.props.imgUrl) {
					return _react2["default"].createElement(
						"div",
						{ className: "gallery" },
				...
				return _react2["default"].createElement(
					...
					_react2["default"].createElement(
						...
						_react2["default"].createElement(
							...
							_react2["default"].createElement("img", { src: "/pics/" + _this.props.id + "/" + _this.props.imgUrl, className: "img-bg" })
						)
					),
					_react2["default"].createElement(
						"button",
	...
	var GalleryForm = (function (_React$Component) {
		...
		function GalleryForm() {
			...
			this.handleSubmit = function (e) {
				e.preventDefault();
				var description = _this.refs.description.value;
				var title = _this.refs.title.value;
				_this.props.onFormSubmit({ title: title, description: description });
			...
			this.render = function () {
				return _react2['default'].createElement(
					...
					_react2['default'].createElement(
						'form',
						{ onSubmit: _this.handleSubmit, ref: 'form' },
						_react2['default'].createElement(
							'div',
							...
							_react2['default'].createElement('input', { type: 'text', name: 'title', ref: 'title', id: 'title', className: 'form-control', required: true })
						),
						_react2['default'].createElement(
							'div',
							{ className: 'form-group' },
							...
							_react2['default'].createElement('textarea', { rows: '5', name: 'description', ref: 'description', id: 'description', className: 'form-control' })
						),
						_react2['default'].createElement('input', { type: 'submit', value: 'Vytvořit', className: 'btn btn-primary' })
					)
				);
			};
		}
